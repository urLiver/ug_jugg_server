...
init() 
{
	...
	add_map_to_maplist( "mp_showdown_sh", 			"Showdown", 			"Rooftop Rumble", 				"Clippy", 							scripts\jugg\maps\edits::showdown_edit1 );
	add_map_to_maplist( "mp_rust", 					"Rust", 				"Run Around Rust",				"Clippy", 							scripts\jugg\maps\edits::rust_edit1 );
	add_map_to_maplist( "mp_village", 				"Village", 				"Village Sux", 					"Unveiled", 						scripts\jugg\maps\edits::village_edit1 );
	add_map_to_maplist( "mp_hillside_ss",			"Getaway", 				"Beach Invasion", 				"TMGlion", 							scripts\jugg\maps\edits::Getaway_edit1 );
	add_map_to_maplist( "mp_paris", 				"Resistance", 			"Alley Annihilation", 			"Revox", 							scripts\jugg\maps\edits::resistance_edit1 );
	add_map_to_maplist( "mp_paris",					"Resistance", 			"Roof Revenge", 				"Clippy", 							scripts\jugg\maps\edits::resistance_edit2 );
	add_map_to_maplist( "mp_paris", 				"Resistance", 			"Lush Lane", 					"TMGlion", 							scripts\jugg\maps\edits::resistance_edit3 );
	add_map_to_maplist( "mp_exchange",				"Downturn", 			"Running For Cover", 			"Unveiled & Clippy", 				scripts\jugg\maps\edits::downturn_edit1 );
	add_map_to_maplist( "mp_exchange",				"Downturn", 			"Crossing The Bridge", 			"Unveiled, Clippy & TMGlion", 		scripts\jugg\maps\edits::downturn_edit2 );
	add_map_to_maplist( "mp_exchange", 				"Downturn", 			"Gated Roofs", 					"TMGlion", 							scripts\jugg\maps\edits::downturn_edit3 );
	add_map_to_maplist( "mp_lambeth", 				"Fallen", 				"Rundown Warehouse", 			"Revox", 							scripts\jugg\maps\edits::fallen_edit1 );
	add_map_to_maplist( "mp_lambeth", 				"Fallen", 				"Fallen Chimney", 				"Clippy & TMGlion", 				scripts\jugg\maps\edits::fallen_edit2 );
	add_map_to_maplist( "mp_hardhat", 				"Hardhat", 				"Construction Pit", 			"Clippy & TMGlion", 				scripts\jugg\maps\edits::hardhat_edit1 );
	add_map_to_maplist( "mp_hardhat", 				"Hardhat", 				"Road Refuge", 					"Clippy & TMGlion", 				scripts\jugg\maps\edits::hardhat_edit2 );
	add_map_to_maplist( "mp_mogadishu", 			"Bakaara", 				"Attack on the backlot", 		"Unveiled & Clippy", 				scripts\jugg\maps\edits::bakaara_edit1 );
	add_map_to_maplist( "mp_mogadishu", 			"Bakaara", 				"Docks", 						"Clippy & TMGlion", 				scripts\jugg\maps\edits::bakaara_edit2 );
	add_map_to_maplist( "mp_mogadishu", 			"Bakaara", 				"Guns N' Roofs", 				"TMGlion", 							scripts\jugg\maps\edits::bakaara_edit3 );
	add_map_to_maplist( "mp_bravo", 				"Mission", 				"Open plane with a building", 	"Unveiled",							scripts\jugg\maps\edits::mission_edit1 );
	add_map_to_maplist( "mp_bravo", 				"Mission", 				"Around & Up", 					"Clippy, Sloth & TMGlion", 			scripts\jugg\maps\edits::mission_edit2 );
	add_map_to_maplist( "mp_favela", 				"Favela", 				"Jesus", 						"Clippy & TMGlion", 				scripts\jugg\maps\edits::favela_edit1 );
	add_map_to_maplist( "mp_favela", 				"Favela", 				"Streets & Roofs", 				"Revox & TMGlion", 					scripts\jugg\maps\edits::favela_edit2 );
	add_map_to_maplist( "mp_interchange", 			"Interchange", 			"Highway...", 					"Unveiled & Clippy & TMGlion", 		scripts\jugg\maps\edits::interchange_edit1 );
	add_map_to_maplist( "mp_interchange",	 		"Interchange", 			"between two warehouses", 		"Unveiled",							scripts\jugg\maps\edits::interchange_edit2 );
	add_map_to_maplist( "mp_seatown", 				"Seatown", 				"Coast Castle", 				"Clippy", 							scripts\jugg\maps\edits::seatown_edit1 );
	add_map_to_maplist( "mp_seatown", 				"Seatown", 				"Truck Gate", 					"Unveiled & Clippy", 				scripts\jugg\maps\edits::seatown_edit2 );
	add_map_to_maplist( "mp_plaza2", 				"Arkaden",				"Plaza Road", 					"Revox", 							scripts\jugg\maps\edits::arkaden_edit1 );
	add_map_to_maplist( "mp_plaza2", 				"Arkaden",				"Bridge Domination", 			"Unveiled & Clippy", 				scripts\jugg\maps\edits::arkaden_edit2 );
	add_map_to_maplist( "mp_alpha", 				"Lockdown", 			"Roof Runners", 				"Clippy", 							scripts\jugg\maps\edits::lockdown_edit1 );
	add_map_to_maplist( "mp_alpha", 				"Lockdown", 			"Street Scurry", 				"TMGlion", 							scripts\jugg\maps\edits::lockdown_edit2 );
	add_map_to_maplist( "mp_carbon", 				"Carbon", 				"Factory Fumbling", 			"Unveiled, Clippy & TMGlion", 		scripts\jugg\maps\edits::carbon_edit1 );
	add_map_to_maplist( "mp_bootleg",				"Bootleg", 				"Tuk Tuk Trouble", 				"Revox", 							scripts\jugg\maps\edits::bootleg_edit1 );
	add_map_to_maplist( "mp_bootleg",				"River", 				"River Splashing",				"Unveiled", 						scripts\jugg\maps\edits::bootleg_edit2 );
	add_map_to_maplist( "mp_dome", 					"Dome",	 				"Bunker Defence", 				"TMGlion",							scripts\jugg\maps\edits::dome_edit3 );
	add_map_to_maplist( "mp_underground", 			"Underground", 			"Loading Bay", 					"Clippy & TMGlion", 				scripts\jugg\maps\edits::underground_edit1 );
	add_map_to_maplist( "mp_underground", 			"Underground", 			"The Long Road", 				"TMGlion", 							scripts\jugg\maps\edits::underground_edit2 );
	add_map_to_maplist( "mp_underground", 			"Underground", 			"Abandoned Station", 			"TMGlion", 							scripts\jugg\maps\edits::underground_edit3 );
	add_map_to_maplist( "mp_nightshift", 			"Skidrow", 				"The Long Straight", 			"Clippy & TMGlion", 				scripts\jugg\maps\edits::skidrow_edit1 );
	add_map_to_maplist( "mp_nightshift", 			"Skidrow", 				"Venting rooftop",				"Clippy & TMGlion", 				scripts\jugg\maps\edits::skidrow_edit2 );
	add_map_to_maplist( "mp_nightshift", 			"Skidrow", 				"Stairway Struggle", 			"TMGlion", 							scripts\jugg\maps\edits::skidrow_edit3 );
	add_map_to_maplist( "mp_terminal_cls",	 		"Terminal", 			"Airport Shops", 				"Clippy", 							scripts\jugg\maps\edits::terminal_edit1 );
	...
	add_map_to_maplist( "mp_vacant", 				"Vacant", 				"Shit Vacant", 					"Clippy", 							scripts\jugg\maps\edits::vacant_edit2 );
	add_map_to_maplist( "mp_lockout_h2", 			"Lockout H2", 			"Halo Ascension", 				"Clippy & TMGlion", 				scripts\jugg\maps\edits::lockout_h2_edit1 );
	...
	add_map_to_maplist( "mp_poolparty", 			"Pool Party", 			"Dock Party", 					"Clippy", 							scripts\jugg\maps\edits::poolparty_edit1 );
	add_map_to_maplist( "mp_firingrange", 			"Firing Range", 		"Target Practice", 				"Clickerz", 						scripts\jugg\maps\edits::firingrange_edit1 );
	add_map_to_maplist( "mp_minecraft", 			"Minecraft",		 	"Mining & Camping", 			"Clippy", 							scripts\jugg\maps\edits::minecraft_edit1 );
	add_map_to_maplist( "mp_dome", 					"Dome", 				"Simple Times", 				"urLiver",							scripts\jugg\maps\edits::dome_liver_1 );
	add_map_to_maplist( "mp_underground", 			"Underground", 			"Running down the Allyway", 	"urLiver", 							scripts\jugg\maps\edits::underground_liver_1 );
...
add_map_to_maplist( map, display_name, edit_name, maker, edit_func ) 
{
