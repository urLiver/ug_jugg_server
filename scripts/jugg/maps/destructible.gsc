init()
{
    ...
    print( "^1destructible::init()^7: Start of Printing Destructibles for map ^2" + getdvar( "mapname" ) );
    ...
    print( "^1destructible::init()^7: End of Printing Destructibles" );


    print( "^1destructible::init()^7: Start of Printing Lanterns for map ^2" + getdvar( "mapname" ) );
    ...
    print( "^1destructible::init()^7: End of Printing Lanterns" );
    

    print( "^1destructible::init()^7: Start of Printing Toys for map ^2" + getdvar( "mapname" ) );
    ...
    print( "^1destructible::init()^7: End of Printing Toys" );
}